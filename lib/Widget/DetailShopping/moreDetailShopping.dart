...
class moreDetailShopping extends StatefulWidget {
  const moreDetailShopping({super.key});

  @override
  State<moreDetailShopping> createState() => _moreDetailShoppingState();
}

class _moreDetailShoppingState extends State<moreDetailShopping> {
  // Title List Here
  var titleList = [
    "ส่วนลดเมื่อซื้อครบ 400",
    "ส่วนลดเมื่อซื้อครบ 450",
    "ส่วนลดเมื่อซื้อครบ 500",
    "ส่วนลดเมื่อซื้อครบ 600",
  ];

  // Description List Here
  var descList = [
    "ส่วนลดเมื่อซื้อสินค้าประเภทนมครบ 400",
    "ส่วนลดเมื่อซื้อสินค้าประเภทอาหารสำเร็จรูปครบ 450",
    "ส่วนลดเมื่อซื้อสินค้าประเภทเสื้อผ้าครบ 500",
    "ส่วนลดเมื่อซื้อสินค้าประเภทเครื่องใช้ไฟฟ้าครบ 600",
  ];
