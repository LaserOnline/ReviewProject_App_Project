...
class moreDetailHotel extends StatefulWidget {
  const moreDetailHotel({super.key});

  @override
  State<moreDetailHotel> createState() => _moreDetailHotelState();
}

class _moreDetailHotelState extends State<moreDetailHotel> {
  // Title List Here
  var titleList = [
    "Standard Room",
    "Double Room",
  ...
  var descList = [
    "เตียงใหญ่ 1 เตียง",
    "เตียงใหญ่ 1 เตียง หรือ เตียงเดี่ยว 2 เตียง",
    "เตียงเดี่ยว 3 เตียง",
    "เตียงใหญ่ 1 เตียง หรือ เตียงเดี่ยว 2 เตียง เห็นวิวทะเล",
  ];
