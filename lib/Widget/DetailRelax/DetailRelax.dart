...
import 'moreDetailRelax.dart';
import '../../models/Loading/Loading.dart';

class DetailRelax extends StatefulWidget {
  const DetailRelax({super.key});

  @override
  State<DetailRelax> createState() => _DetailRelaxState();
}

class _DetailRelaxState extends State<DetailRelax> {
  int id = 0;
  final urlImages = [
