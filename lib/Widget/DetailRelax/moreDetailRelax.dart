...
class moreDetailRelax extends StatefulWidget {
  const moreDetailRelax({super.key});

  @override
  State<moreDetailRelax> createState() => _moreDetailRelaxState();
}

class _moreDetailRelaxState extends State<moreDetailRelax> {
  // Title List Here
  var titleList = [
    "นวดแผนไทย",
    "นวดแผนไทย + กดจุด",
  ...
  var descList = [
    "นวดแผนไทย 5 ครั้ง",
    "นวดแผนไทย + กดจุด 5 ครั้ง",
    "นวดแผนไทย + ฝังเข็ม 5 ครั้ง",
    "นวดหน้า 5 ครั้ง",
  ];
