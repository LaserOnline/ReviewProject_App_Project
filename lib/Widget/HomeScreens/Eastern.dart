...
class Eastern extends StatefulWidget {
  const Eastern({Key? key}) : super(key: key);

  @override
  State<Eastern> createState() => _Eastern();
}

class _Eastern extends State<Eastern> {
  var domain = new ApiRequestDatabases();
  var api_content = new Content();
  int index = 0;
  final String Region = "ภาคตะวันออก";
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: api_content.LoadRegion(Region),
